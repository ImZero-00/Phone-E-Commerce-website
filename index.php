      ...
      <div class="container">
        <div class="hero-content">
          ...
          <div class="hero-buttons">
            <a href="pages/products.php" class="btn btn-primary btn-lg">Mua ngay</a>
            <a href="pages/products.php" class="btn btn-outline-light btn-lg">Xem sản phẩm</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      ...
      <div class="row g-4">
        <div class="col-6 col-md-3">
          <a href="pages/products.php?category=iphone" class="category-card">
        ...
        <div class="col-6 col-md-3">
          <a href="pages/products.php?category=samsung" class="category-card">
            <div class="category-icon">
        ...
        <div class="col-6 col-md-3">
          <a href="pages/products.php?category=xiaomi" class="category-card">
            <div class="category-icon">
        ...
        <div class="col-6 col-md-3">
          <a href="pages/products.php?category=other" class="category-card">
            <div class="category-icon">
  ...
  <section class="featured-section" id="featured">
    <div class="container">
      ...
      <div class="text-center mt-5">
        <a href="pages/products.php" class="btn btn-outline-primary btn-lg">Xem tất cả sản phẩm</a>
      </div>
    </div>
  </section>
</main>
